...
import getMockedCurrencies from "@/domain/mocks/currency-mocks";
...
export async function loader(args: LoaderFunctionArgs) {
  ...
  return typedjson({
    ...
    currencies: getMockedCurrencies(),
  });
}
...
export default function ServicesCreate() {
  ...
  const { paymentMethods, categories, currencies } = useTypedLoaderData<typeof loader>();
            ...
            <div className="mx-auto grid max-w-[59rem] flex-1 auto-rows-max gap-4">
              <div className="flex items-center gap-4">
                ...
                <div className="hidden items-center gap-2 md:ml-auto md:flex">
                  ...
                  <Button size="sm" type="submit">Create Service</Button>
                </div>
              </div>
                      ...
                      <Select onValueChange={field.onChange}>
                        ...
                        <SelectContent>
                          {currencies.map((currency, index) => {
                            return <SelectItem key={currency.id}
                                               value={currency.id}>{currency.code}</SelectItem>;
                          })}
                        </SelectContent>
                      </Select>
                      <FormMessage />
