...
export default function OrderDetail() {
  const lang = "en";
  const { order, service, paymentMethod, currency, user } = useTypedLoaderData<typeof loader>();

  console.log(order, service, paymentMethod, currency, user);
  return <Card
      ...
      <div className="grid gap-3">
        ...
        <ul className="grid gap-3">
          <li className="flex items-center justify-between">
            ...
            <span>{currency.code} {order.totalPrice.amount}</span>
          </li>
        </ul>
      ...
      <div className="grid gap-3">
        ...
        <dl className="grid gap-3">
          <div className="flex items-center justify-between">
            ...
            <dd>{paymentMethod.description[lang]}</dd>
          </div>
        </dl>
      </div>
    </CardContent>
